...
if ($_SERVER['HTTP_HOST'] == 'localhost'):
    ...
    define('SIS_DB_DBSA', 'maizup2019'); //Nome  do banco de dados no localhost
else:
    define('SIS_DB_HOST', 'mysql873.umbler.com'); //Link do banco de dados no servidor
    define('SIS_DB_USER', 'maizup_root'); //Usuário do banco de dados no servidor
    define('SIS_DB_PASS', 'qaz159poI*'); //Senha  do banco de dados no servidor
    define('SIS_DB_DBSA', 'maizup2019'); //Nome  do banco de dados no servidor
endif;
/*
 * CACHE E CONFIG
 */
...
// THEMESTUDIO CONFIG
require 'Config.ThemeStudio.inc.php'; //Configuracões do ThemeStudio
