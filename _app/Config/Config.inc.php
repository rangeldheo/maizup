...
if (!$WorkControlDefineConf):
    ...
    if($_SERVER['HTTP_HOST'] == 'localhost'):
        define('BASE', 'https://localhost/00-maizup'); //Url raiz do site no localhost
    else:
        define('BASE', 'https://maistemas.com/maizup'); //Url raiz do site no servidor
    endif;
    define('THEME', 'default'); //template do site
endif;
