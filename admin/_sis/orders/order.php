        ...
        <article class="box box70">
            <div class="panel">
                ...
                <div class="single_order_items">
                    ...
                    if (!$Read->getResult()):
                        ...
                        foreach ($Read->getResult() as $Item):
                            ...
                            if ($Item['pdt_id']):
                                echo "<p><b>" . str_pad($Item['item_id'], 5, 0, STR_PAD_LEFT) . "</b> - <a target='_blank' href='dashboard.php?wc=products/create&id={$Item['pdt_id']}' title='Ver Produto!'>" . Check::Words($Item['item_name'], 4) . "{$ProductSize}</a></p>";
                ...
                <div class="label_50">
                    ...
                    <label class="label">
                        <span class="legend icon-truck single_order_traking j_content"><?= $order_tracking && $order_tracking != 1 ? "<a title='Rastrear Pedido' target='_blank' href='{$Traking}{$order_tracking}'>RASTREIO:</a>" : 'RASTREIO: (informe <b>1</b> para enviar sem rastreio!'; ?></span>
