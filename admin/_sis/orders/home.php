...
<div class="dashboard_content">
    ...
    <div class="box box100">
        ...
        <div class="panel">
            ...
            if (!$Read->getResult()):
                $Pager->ReturnPage();
                echo Erro("<span class='al_center icon-notification'>Olá {$Admin['user_name']}. Assim que um cliente iniciar um novo pedido você poderá acompanhar aqui!</span>", E_USER_NOTICE);
            else:
