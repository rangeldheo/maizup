...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-cart">Pedidos Concluídos</h1>
...
<div class="dashboard_content">
    ...
    <div class="box box100">
        ...
        <div class="panel_header default">
            <h2 class="icon-cart">Pedidos Completos</h2>
        </div>
        ...
        <div class="panel">
            ...
            $Read->ExeRead(DB_ORDERS, "WHERE order_status = 1 ORDER BY order_status DESC, order_date DESC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}");
            if (!$Read->getResult()):
                $Pager->ReturnPage();
                echo Erro("<span class='al_center icon-notification'>Olá {$Admin['user_name']}. Ainda não existem pedidos concluídos :(</span>", E_USER_NOTICE);
            else:
            ...
            $Pager->ExePaginator(DB_ORDERS, "WHERE order_status = 1");
