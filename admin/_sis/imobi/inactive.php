...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-home3">Imóveis Inativos</h1>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        echo Erro("<span class='al_center icon-notification'>Parabéns, não existem imóveis indisponíveis {$Admin['user_name']}!</span>", E_USER_NOTICE);
    else:
